...
enum TransactionType {deine , leine }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Khata App',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),)),
      ),
      body: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('\$${_calculateTotal(TransactionType.deine).toStringAsFixed(2)}',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('\$${_calculateTotal(TransactionType.leine).toStringAsFixed(2)}',
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ListTile(
                  ...
                  subtitle: Text(
                    '\$${displayedTransactions[index].amount.toStringAsFixed(2)} - ${displayedTransactions[index].dateTime}\n${displayedTransactions[index].customerName} - ${displayedTransactions[index].phoneNumber}',
                  ),
                  trailing: Icon(
                    displayedTransactions[index].type == TransactionType.deine
                        ? Icons.arrow_upward
                        : Icons.arrow_downward,
                    color: displayedTransactions[index].type == TransactionType.deine
                        ? Colors.green
                        : Colors.red,
                  ),
                  onTap: () {
      ...
      floatingActionButton: GestureDetector(
        ...
        child: Container(
          ...
          child: Center(child: Text('Add Customer',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),)),
        ),
      ),
    );
  }
...
class _AddTransactionPageState extends State<AddTransactionPage> {
  String customerName = '';
  double amount = 0.0;
  TransactionType selectedType = TransactionType.leine;
                ...
                DropdownButton<TransactionType>(
                  ...
                  items: TransactionType.values
                      ...
                      return DropdownMenuItem<TransactionType>(
                        value: value,
                        child: Text(value == TransactionType.deine ? 'deine' : 'leine'),
                      );
                    },
                  )
                      .toList(),
