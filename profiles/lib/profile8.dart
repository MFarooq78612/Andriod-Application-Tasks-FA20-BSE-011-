    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ProfileHeader(
                avatar: NetworkImage('images/pff.jpg'),
                coverImage: NetworkImage('images/pf2/travel.jpg'),
                      ...
                      ...ListTile.divideTiles(
                        ...
                        tiles: [
                          ...
                          const ListTile(
                            ...
                            title: Text("Phone"),
                            subtitle: Text("+92 34256624"),
                          ),
                          const ListTile(
                            leading: Icon(Icons.person),
                            title: Text("About Me"),
                            subtitle: Text(
                                "I'm a desperate student studying in a dreadful institution which haunts everyone."),
                          ),
                        ],
                      ),
                    ],
