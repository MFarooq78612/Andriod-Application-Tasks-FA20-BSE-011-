...
class Profile6 extends StatelessWidget {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          ...
          Image.network('images/pf2/punjab.jpg', fit: BoxFit.cover),
          BackdropFilter(
  ...
  Widget _buildAvatar() {
    return Container(
      ...
      child: ClipOval(
        child: Image.network('images/pff.jpg'),
      ),
    );
  }
...
class VideoCard extends StatelessWidget {
  ...
  Widget _buildThumbnail() {
    return ClipRRect(
      ...
      child: Stack(
        children: <Widget>[
          Image.network('images/pf2/travel.jpg'),
          Positioned(
            bottom: 12.0,
            right: 12.0,
...
final DEV sid = DEV(
  ...
  biography: 'Muhammad Farooq is a Flutter dev  '
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry.  '
      'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.',
  videos: <Video>[
    Video(
      title: 'BOMBASTIC',
      thumbnail: 'images/pff.jpg',
